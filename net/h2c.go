...
// NewH2cHandler returns an http.Handler that wraps h, intercepting any h2c
...
// the result of NewH2cHandler in an http.MaxBytesHandler.
func NewH2cHandler(h http.Handler, s *http2.Server) http.Handler {
	return &h2cHandler{
		Handler: h,
		s:       s,
	}
